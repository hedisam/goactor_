...
func (m *mailbox) sendUserMessage(message interface{}) {
	select {
	case <-m.doneCh:
		return
...
func (m *mailbox) sendSysMessage(message SystemMessage) {
	select {
	case <-m.doneCh:
		return
...
func (m *mailbox) receive(handler MessageHandler) {
	loop:
		select {
...
func (m *mailbox) handleSystemMessage(message SystemMessage) {
...
func (m *mailbox) receiveWithTimeout(handler MessageHandler, timeout time.Duration) {
